import { Page as Page$1, PageData as PageData$1 } from '@vuepress/core';
...
interface I18nPluginLocaleData {
    ...
    outdated: {
         ...
         * @returns localized text
         */
        content: (linkRenderer: LinkRenderer, sourceUpdateTime: number, translationUpdateTime: number, sourceLink: string) => string;
    };
}
...
type Page = Page$1<I18nPluginPageData, I18nPluginFrontmatter>;
type PageData = PageData$1<I18nPluginPageData>;

export { I18nPluginLocaleData as I, LinkRenderer as L, Page as P, I18nData as a, I18nPluginFrontmatter as b, I18nPageData as c, I18nPluginPageData as d, PageData as e };
